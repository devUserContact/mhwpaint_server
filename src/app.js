...
app.get('/mhwpaint/cart/:cart_items', cors(corsOptions), async function (req, res) {
...
// paypal 
app.get("/mhwpaint/orders", cors(corsOptions), async (req, res) => {
  try {
...
app.get("/mhwpaint/orders/:orderID/capture", cors(corsOptions), async (req, res) => {
  try {
